...
## Corpus Check
- 76 files · ~21,684 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 449 nodes · 588 edges · 63 communities (59 shown, 4 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e685e344`
...
- `SignalAggregator` --uses--> `Direction`  [INFERRED]
  agents/consensus/aggregator.py → agents/models.py
...
Cohesion: 0.08
Nodes (16): AgentState, NarrativeIntelligenceAgent, SentimentReasoningAgent, SignalAggregator, create_workflow(), narrative_intelligence_node(), run_analysis(), _run_sequential() (+8 more)
...
## Knowledge Gaps
- **134 isolated node(s):** `narrativeos-cognitive — Zynd-registered NarrativeOS agent mesh wrapper.  Runs th`, `Pull fresh data from Apify actors via MCP client.`, `nextConfig`, `initialNodes`, `initialEdges` (+129 more)
...
- **Why does `main()` connect `Community 9` to `Community 8`, `Community 3`, `Community 12`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `run_analysis()` connect `Community 1` to `Community 12`, `Community 6`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `run_pipeline()` connect `Community 12` to `Community 1`, `Community 4`?**
