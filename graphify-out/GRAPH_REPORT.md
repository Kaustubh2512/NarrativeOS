...
## Corpus Check
- 38 files · ~11,299 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 284 nodes · 396 edges · 29 communities (28 shown, 1 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `263cdfcf`
...
- `NarrativeIntelligenceAgent` --uses--> `Entity`  [INFERRED]
  agents/narrative_intelligence.py → agents/models.py
- `SentimentReasoningAgent` --uses--> `NarrativeEvent`  [INFERRED]
  agents/sentiment.py → agents/models.py
- `NarrativeIntelligenceAgent` --uses--> `NarrativeEvent`  [INFERRED]
  agents/narrative_intelligence.py → agents/models.py
- `NarrativeIntelligenceAgent` --uses--> `TopicCluster`  [INFERRED]
  agents/narrative_intelligence.py → agents/models.py
- `SentimentReasoningAgent` --uses--> `SentimentVector`  [INFERRED]
  agents/sentiment.py → agents/models.py
...
Cohesion: 0.05
Nodes (40): 1. Data Acquisition Agent, 3. Sentiment Reasoning Agent, 4. Market Correlation Agent, 5. Debate Agent System, 7. Strategy Agent, 8. Visualization Agent, Agent Topology, Arbiter Agent (+32 more)

### Community 1 - "Community 1"
Cohesion: 0.13
Nodes (22): AgentState, AnalysisSignal, DebatePosition, DebateRound, DebateSummary, Direction, Entity, NarrativeEvent (+14 more)

### Community 2 - "Community 2"
Cohesion: 0.1
Nodes (11): NarrativeIntelligenceAgent, SentimentReasoningAgent, create_workflow(), narrative_intelligence_node(), run_analysis(), _run_sequential(), sentiment_reasoning_node(), narrative_intelligence_analyze() (+3 more)
...
- **Why does `Agent Topology` connect `Community 0` to `Community 3`, `Community 14`, `Community 15`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `_to_iso()` connect `Community 7` to `Community 1`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `SignalAggregator` connect `Community 1` to `Community 2`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
