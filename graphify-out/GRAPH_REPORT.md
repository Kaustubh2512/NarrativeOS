...
## Corpus Check
- 79 files · ~23,465 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 486 nodes · 639 edges · 64 communities (60 shown, 4 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 93 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d0e5cab8`
...
4. `NarrativeOSDataClient` - 12 edges
5. `SentimentVector` - 11 edges
6. `DebateEngine` - 11 edges
7. `BullAgent` - 10 edges
8. `BearAgent` - 10 edges
9. `ArbiterAgent` - 10 edges
10. `_to_iso()` - 10 edges
...
- `run_analysis_pipeline()` --calls--> `push_event()`  [INFERRED]
  agent.py → infra/superplane/client.py
...
Cohesion: 0.08
Nodes (31): AgentPayload, AnalysisSignal, DebatePosition, DebateRound, DebateSummary, Direction, Entity, NarrativeEvent (+23 more)

### Community 1 - "Community 1"
Cohesion: 0.1
Nodes (21): assess(), compute_confidence_degradation(), compute_risk_score(), detect_anomalies(), estimate_volatility(), extract_risk_factors(), Agent 6: Risk Intelligence Agent — evaluates systemic uncertainty and signal rel, str (+13 more)

### Community 2 - "Community 2"
Cohesion: 0.1
Nodes (14): AgentState, SentimentReasoningAgent, SignalAggregator, create_workflow(), narrative_intelligence_node(), run_analysis(), _run_sequential(), sentiment_reasoning_node() (+6 more)
...
- **Why does `main()` connect `Community 9` to `Community 8`, `Community 5`, `Community 13`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `run_analysis()` connect `Community 2` to `Community 4`, `Community 13`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `run_pipeline()` connect `Community 13` to `Community 0`, `Community 2`?**
...
- **What connects `narrativeos-cognitive — Zynd-registered NarrativeOS agent mesh wrapper.  Runs th`, `Pull fresh data from Apify actors via MCP client.`, `nextConfig` to the rest of the system?**
